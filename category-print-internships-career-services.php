...
<table>
    <tbody>
       <tr style="vertical-align: top; width: 371px;">
            ...
            <td style="width: 70px; line-height:20px; padding-left: 8px;">Print</td>
...
<h4 style="margin-top:50px;">Print Internships:</h4>
  <?php $posts = query_posts('category_name=print-internships-career-services&orderby=title&order=asc&posts_per_page=-1');
