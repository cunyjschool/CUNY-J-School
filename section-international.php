<?php
/*
Template Name: Section - International
*/
?>
...
<ul id="sidebar-nav">
  ...
  <li><a href="<?php bloginfo('url'); ?>/academics/subject-concentrations/">Subject Concentrations</a>
    <ul>
      ...
      <li><a href="<?php bloginfo('url'); ?>/academics/subject-concentrations/international/">International</a>
        <ul>
          <li><a href="<?php bloginfo('url'); ?>/academics/subject-concentrations/international/advisory-board/">Advisory Board</a></li>
          <li><a href="<?php bloginfo('url'); ?>/academics/subject-concentrations/international/faculty/">Faculty</a></li>
        </ul>
      </li>
