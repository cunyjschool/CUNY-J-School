...
<!-- End Slideshow and Nav -->
  ...
  <div class="clearfix" id="news-home">
    <div id="news">
  <h3>News <a href="/category/news/feed"><img src="<?php bloginfo('template_directory'); ?>/img/icons/feed.png" alt="News Feed" class="feed" /></a></h3>
...
<?php endif; ?>
    ...
    <div id="events-home">
  <h3>Events <a href="/category/events/feed/"><img src="<?php bloginfo('template_directory'); ?>/img/icons/feed.png" alt="Events Feed" class="feed" /></a></h3>
...
<div id="fh-inner"><a href="http://fort-greene.thelocal.nytimes.com/"><img src="/wp-content/uploads/2010/07/fort-greene_main-200x50px.jpg" alt="The Local" /></a>
...
<h4 style="float: right;">View All Recent Activity on the <a href="/wire/">Wire &raquo;</a></h4> 
    ...
    <h3 id="clips"><a href="/category/student-work/">Clips of the Week</a></h3>
      <h5>Student work</h5>
      <div>
<ul>
...
?>
  ...
  <div class="clearfix" id="row3">
    <div id="dc">
        <h3>Dean's Corner</h3>
<a href="/about/deans-corner/"><img src="/wp-content/themes/cunyjschool/img/dean-shepard.jpg"></a>
