		...
		<div class="row-section">
  		...
  		<div class="program-courses row-section">
			...
			<ul>
				...
				<li><h4><a href="<?php bloginfo('url'); ?>/academics/entrepreneurial-journalism/apprenticeship/">New Media Apprenticeship</a></h4>
					...
					<p><a href="<?php bloginfo('url'); ?>/academics/entrepreneurial-journalism/apprenticeship/">Learn more &rarr;</a></p>
				</li>
				<li><h4><a href="<?php bloginfo('url'); ?>/academics/entrepreneurial-journalism/incubation/">New Business Incubation</a></h4>
					...
					<p><a href="<?php bloginfo('url'); ?>/academics/entrepreneurial-journalism/incubation/">Learn more &rarr;</a></p>
				</li>				
				<li><h4><a href="<?php bloginfo('url'); ?>/academics/entrepreneurial-journalism/business-fundamentals/">Fundamentals of Business</a></h4>
					...
					<p><a href="<?php bloginfo('url'); ?>/academics/entrepreneurial-journalism/business-fundamentals/">Learn more &rarr;</a></p>
				</li>
			</ul>
